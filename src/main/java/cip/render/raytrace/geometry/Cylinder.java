 ...
 * <tr>
 * <td><tt>face</tt></td>
 * <td><i>Optional, none for a true cylinder.</i> The plane equation of a clipping face.  There are as many <tt>face</tt> entries
 * as there are clipping planes on the cylinder.
 ...
 * </ul>
 *  If no face material is specified, the cylinder material is used. Face materials are best used with opaque
 *  objects. Specifying different transparent materials for the cylinder and faces should be avoided unless the
